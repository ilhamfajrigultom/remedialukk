...
<div class="d-flex justify-content-center py-5 mt-5">
  <div class="card shadow mt-3 border-bottom-primary bg-gray-100 w-50" data-aos="fade-down">
    <div class="card-body">
      ...
      <?php endif; ?>
      <h3 class="text-center text-primary text-uppercase text-bold">Admin - Petugas</h3>
        ...
        <div class="col-6">
          <form action="" method="post">
            ...
            <div class="text-center mt-2">
              <a href="../../index.php" class="text-gray-600" style="text-decoration: none;">Login Masyarakat</a>
            </div>
          </form>
        </div>
        <div class="col-6">
          <div class="image">
            <img src="../../assets/img/officer.png" width="320" alt="">
          </div>
        </div>
      </div>
    </div>
