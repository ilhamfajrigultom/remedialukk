        ...
        <div class="col-6">
          <form action="" method="post">
            ...
            <div class="">
              ...
              <a href="src/petugas/login.php" class="btn btn-outline-primary ml-2">Masuk sebagai petugas</a>
            </div>
            <div class="text-center mt-2">
              <a href="src/user/register.php" class="text-gray-600" style="text-decoration: none;">Belum Punya Akun?</a>
            </div>
          </form>
        </div>
      </div>
